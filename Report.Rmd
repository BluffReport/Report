...
ggplot(data, aes(x = `max.wave.height`, y = `rr`, color = as.factor(seawall))) +
  ...
  labs(title = "Scatter Plot of Max Wave Height  vs. Retreat Rate",
       x = " Max Wave Height(m) ", 
       y = "Retreat Rate (m/yr)") +
  theme_minimal() +
...
ggplot(data, aes(x = `mud.comp`, y = `rr`, color = as.factor(seawall))) +
  ...
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  scale_color_manual(values = c("#FF6666", "#66B2FF"), name = "Seawall") +
  labs(title = "Scatter Plot of Mud Rate vs. Retreat Rate",
       x = " Mud(%)", 
       y = "Retreat Rate (m/yr)") +
  theme_minimal() +
  theme(legend.title = element_text(size = 12),
...
ggplot(data, aes(x = `base.el`, y = `rr`, color = as.factor(seawall))) +
  ...
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  scale_color_manual(values = c("#FF6666", "#66B2FF"), name = "Seawall") +
  labs(title = "Scatter Plot of Base Elevation vs. Retreat Rate",
       x = " Base Elevation(m)", 
       y = "Retreat Rate (m/yr)") +
  theme_minimal() +
  theme(legend.title = element_text(size = 12),
...
ggplot(data, aes(x = `bluff.el`, y = `rr`, color = as.factor(seawall))) +
  ...
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  scale_color_manual(values = c("#FF6666", "#66B2FF"), name = "Seawall") +
  labs(title = "Scatter Plot of Bluff Elevation vs. Retreat Rate",
       x = " Bluff Elevation(m)", 
       y = "Retreat Rate (m/yr)") +
  theme_minimal() +
  theme(legend.title = element_text(size = 12),
