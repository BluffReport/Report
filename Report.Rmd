...
## other findings
```{r box-plot, echo = FALSE, message = FALSE, fig.cap = "box plot of bluff seawall and retreat rates",warning=FALSE}
...
Figure \@ref(fig:box-plot) demonstrates that the box for the group with a seawall is larger, indicating that the retreat rate values in this group vary more than those in the group without a seawall.The wider range of retreat rate values in the presence of a seawall could suggest that other factors might have a larger impact on retreat rates when seawalls are present.
