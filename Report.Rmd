...
* Cluster 1 includes the following bluffs: Georges 1, Georges 2, Rainsford 1, Lovells 2, Long 1, GB 1, GB 3, GB 4, and Gallops 1. Bluffs in this cluster have 

* Cluster 2 includes the following bluffs: Long 2, Peddocks 1, Peddocks 2, Peddocks 5, Peddocks 6, Peddocks 7, Peddocks 8, Moon 1, Moon 2, Thompson 1, Webb 2, Bumpkin 1, Thompson 2, and Thompson 3. 

* Cluster 3 includes the following bluffs: Long 3, GB 2, Peddocks 3, Peddocks 4, Lovells 1, Bumpkin 2, Thompson 4, and Webb 1. This cluster contains bluffs with lower retreat rates as well as higher retreat rates. Although Lovells 1, Thompson 4, and Webb 1 have higher retreat rates compared to the other bluffs, they share other similar characteristics with the other bluffs. All bluffs in this cluster have orientations facing the Northwest direction and have very similar base elevations. Besides Lovells 1, all bluffs do not have a seawall present.
