...
We begin the data exploration by observing the relationship and patterns between each of the variables  with the retreat rates of the bluffs. \ 
...
From the plot, we can observe a trend indicated by the fitted red line, which suggests a positive correlation between wave height and retreat rate—higher wave heights are associated with higher rates of retreat.
...
```{r heatmap-plot, echo = FALSE, warning = FALSE, fig.cap="Clustered heatmap of 31 bluffs.", out.width=700}
#heatmap
...
```{r polar-plot, fig.width=10, fig.height=8, echo=FALSE, fig.cap = "Polar plot of bluff degree orientation and erosion rates"}
